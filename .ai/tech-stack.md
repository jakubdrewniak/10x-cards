...
- Playwright do zaawansowanych testów integracyjnych oraz testów end-to-end
- Storybook do testów wizualnych komponentów i dokumentacji
- ESLint, TypeScript, Prettier do testów statycznych
